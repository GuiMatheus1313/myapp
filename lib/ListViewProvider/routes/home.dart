...
import 'package:myapp/ListViewProvider/state/count.dart';
import 'package:myapp/ListViewProvider/routes/routeGenerator.dart';
      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.of(context).pushNamed(RouteGenerator.second);
              },
