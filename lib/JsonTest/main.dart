...
''';
  ...
  runApp(MaterialApp(
    home: MyJson(jsonMagos: jsonMagos)));
}
...
class MyJson extends StatelessWidget {
  ...
  MyJson({super.key, required this.jsonMagos});

  
  @override
  Widget build(BuildContext context) {
    // TODO: implement build
    final List<Mago> magos = Mago.carregarMagos(jsonMagos);
     return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return ListTile(
            ...
            subtitle: Text('Nível: ${mago.nivelMagico} | Mana: ${mago.mana} | Feitiço1: ${mago.feitico1} | Feitiço2: ${mago.feitico2} | Feitiço3: ${mago.feitico3}'  ),
          );
        },
      ),
    );
